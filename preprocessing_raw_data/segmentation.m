...
nb_inf = ceil( t_min*tx_amost/1000 );
nb_sup = ceil( t_max*tx_amost/1000 );
rm_inf = ceil( rmbase_min*tx_amost/1000 );
rm_sup = ceil( rmbase_max*tx_amost/1000 );
